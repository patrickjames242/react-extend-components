...
test('passes props to underlying child element', () => {
  const TestComponent = extendComponent('div', { button: 'button' })(
    (Div, { Button }) => {
      return (
        <Div>
          <Button />
